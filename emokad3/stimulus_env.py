...
class Env():
    ...
    def changeSave(self)    : self.__save  = not self.__save
    def changeSerius(self)  : self.__serius  = not self.__serius
    def addState(self)      : self.__state  = (self.__state + 1)%2
    def subState(self)      : self.__state  = (self.__state + 3)%2

    def getFPS(self)        : return self.__fps
    def getRun(self)        : return self.__run
    def getSave(self)       : return self.__save
    def getStop(self)       : return self.__stop
    def getState(self)      : return self.__state
    def getSerius(self)     : return self.__serius
